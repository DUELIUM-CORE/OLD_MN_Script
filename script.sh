...
TMP_FOLDER=$(mktemp -d)
CONFIG_FILE='Duelium.conf'
CONFIGFOLDER='/root/.Duelium'
COIN_DAEMON='Dueliumd'
COIN_CLI='Duelium-cli'
COIN_PATH='/usr/local/bin/'
COIN_TGZ='https://github.com/DUELIUM-CORE/DUELIUM/releases/download/1.1.0.5/Duelium-x86_64-linux.tar.gz'
...
addnode=108.61.216.155:8887
addnode=108.61.218.224:8887
EOF
}
